...
import { ChevronDown, ChevronUp, Close, Mobile, Restart } from "@/components/ui/Icons";
...
function PreviewRun({ form, onClose }: { form: FormDetail; onClose: () => void }) {
  ...
  const go = useCallback(
    ...
    [cancelAutoAdvance, step, form.questions, answers, steps.length],
  );
  ...
  const setAnswer = useCallback(
    ...
    [cancelAutoAdvance, step, form.questions, steps.length],
  );
                ...
                >
                  ...
                  {step.kind === "question" && form.questions[step.index] && (
                    <QuestionScreen
                      ...
                      error={error}
                      shakeKey={shake}
                      isLast={step.index === form.questions.length - 1}
                    />
                  )}
                  ...
                  {step.kind === "ending" && (
                    <ThankYouScreen
                      form={form}
                      heading={form.thank_you_heading}
